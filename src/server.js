...
async function runMigrations() {
  ...
  } catch (e) { console.error('Migration tipos_servico_lavagem erro:', e.message); }

  // Tipos de caminhão (para serviços que exigem tipo, ex: Lavagem)
  try {
    await _prisma.$executeRawUnsafe(`
  ...
  // Fornecedores de lavagem/serviços
  try {
    await _prisma.$executeRawUnsafe(`
  ...
  // Preços: fornecedor x tipo de serviço x tipo de caminhão (opcional)
  try {
    await _prisma.$executeRawUnsafe(`
  ...
  } catch (e) { console.error('Migration precos_fornecedor_servico erro:', e.message); }

  // Registros de lavagem/serviço
  try {
    await _prisma.$executeRawUnsafe(`
